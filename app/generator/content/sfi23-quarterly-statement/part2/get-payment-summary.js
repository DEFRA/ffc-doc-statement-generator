...
const getPaymentSummary = (sfi23QuarterlyStatement) => {
  ...
  paymentSummary.push({ text: [{ text: 'Payment amount: ', bold: true, lineBreak: false, style: 'separator' }, `${toCurrencyString(sfi23QuarterlyStatement.paymentAmount).toString()}`] })
