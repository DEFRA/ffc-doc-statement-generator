...
const part1 = (sfi23QuarterlyStatement) => {
  ...
  return {
    stack: [
      { text: `${sfi23QuarterlyStatement.scheme.name} (${sfi23QuarterlyStatement.scheme.shortName}) ${sfi23QuarterlyStatement.scheme.year} agreement: quarterly payment statement `, style: 'header2' },
      ...
      { text: `Your ${sfi23QuarterlyStatement.scheme.shortName} ${sfi23QuarterlyStatement.scheme.year} agreement`, style: 'header3' },
