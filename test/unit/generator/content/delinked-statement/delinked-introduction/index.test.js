...
describe('delinkedIntroduction', () => {
  test('should correctly generate delinkedIntroduction content', () => {
    ...
    expect(delinkedIntroductionResult.stack).toContainEqual({ text: 'This statement explains your most recent annual delinked payment, including your reference amount and progressive reduction.' })
