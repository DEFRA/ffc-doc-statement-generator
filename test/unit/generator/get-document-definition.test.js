...
const { STATEMENT, SFI23QUARTERLYSTATEMENT } = require('../../../app/constants/document-types')

describe('get document definition', () => {
  test('includes A4 paper size', () => {
    const result = getDocumentDefinition(mockStatement, STATEMENT, SFI23QUARTERLYSTATEMENT)
